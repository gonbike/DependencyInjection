...
namespace AspectCore.Container.Autofac
{
    public static class RegistrationBuilderExtensions
    {
            ...
            where TConcreteReflectionActivatorData : ConcreteReflectionActivatorData
        {
            ...
            {
                AutofacOriginalServiceProvider.MapActivatorData(interfaceType, activatorData);
            }
            ...
            registration.OnActivating(args =>
            {
                ...
                var proxyType = proxyGenerator.CreateClassProxyType(activatorData.ImplementationType, activatorData.ImplementationType, interfaceTypes);
            ...
            where TConcreteReflectionActivatorData : ConcreteReflectionActivatorData
        {
            ...
            AutofacOriginalServiceProvider.MapActivatorData(serviceType, activatorData);
